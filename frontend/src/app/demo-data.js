  ...
  const clients = [
    {
      ...
      notes: 'Cliente com acompanhamento ativo em demanda cível e prazos fatais nesta semana.',
    },
    {
    ...
    },
    {
      ...
      notes: 'Atendimento pontual em ação indenizatória.',
    },
  ];
  ...
  const processes = [
    {
      ...
      description: 'Ação de obrigação de fazer com pedido de tutela de urgência.',
      court: '12ª Vara Cível de São Paulo',
      area: 'Civel',
      status: 'Em andamento',
      owner: 'Mariana Souza',
    },
    {
      ...
      description: 'Reclamação trabalhista com audiência inicial designada.',
    ...
    },
    {
      ...
      description: 'Ação indenizatória por danos materiais e morais.',
  ...
  const events = [
    {
      ...
      description: 'Audiência virtual. Conferir documentos e proposta antes do horário.',
    ...
    },
    {
      ...
      title: 'Reunião de alinhamento trabalhista',
      description: 'Revisar documentos de jornada e estratégia para audiência.',
    ...
    },
    {
      ...
      responsible: 'demo-user-lorenzo',
      responsibleName: 'Lorenzo dos Reis',
  ...
  const deadlines = [
    {
      ...
      description: 'Preparar contestação e documentos para protocolo.',
      date: today,
      status: 'Pendente',
      priority: 'Alta',
      clientId: 'demo-client-bruno',
      ...
      createdBy: 'Renata Sampaio',
      notes: 'Conferir procuração e comprovantes anexos.',
      completed: false,
      elapsedSeconds: 2700,
      timerStartedAt: '',
    },
    {
      ...
      description: 'Manifestação sobre documentos juntados pela parte reclamante.',
      date: tomorrow,
      status: 'Em andamento',
      priority: 'Alta',
      clientId: 'demo-client-almeida',
    ...
    },
    {
      ...
      description: 'Protocolar petição inicial revisada.',
      date: nextWeek,
      status: 'Protocolar',
      priority: 'Media',
      clientId: 'demo-client-ana',
  ...
  const petitions = [
    {
      ...
      pendingReason: 'Aguardando confirmação de documentos complementares.',
      area: 'Civel',
      status: 'Pendente',
      createdBy: 'Renata Sampaio',
