...
urlpatterns = [
    ...
    path(
        ...
        views.categorias_financeiro,
        name="categorias_financeiro",
    ),
    path(
    ...
    path(
        "api/financeiro/<int:lancamento_id>/",
        views.detalhes_lancamento,
        name="detalhes_lancamento",
    ),
    path(
        "api/financeiro/<int:lancamento_id>/editar/",
        views.editar_lancamento,
        name="editar_lancamento",
    ),
    path(
        "api/financeiro/<int:lancamento_id>/excluir/",
        views.excluir_lancamento,
        name="excluir_lancamento",
    ),
    path(
        "api/financeiro/<int:lancamento_id>/marcar-pago/",
        views.marcar_pago,
        name="marcar_pago",
    ),
    path(
        "api/financeiro/<int:lancamento_id>/cancelar/",
