    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('watch_token', models.CharField(blank=True, default='', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timezone', models.CharField(blank=True, default='', max_length=100)),
                ('source_of_truth', models.CharField(choices=[('local', 'Local'), ('google', 'Google')], default='local', max_length=20)),
