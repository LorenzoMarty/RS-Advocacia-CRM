        ...
        demo_clientes = [
            {
                ...
                "cpf": "123.456.789-10",
                "obs": "Cliente demo para agenda civel.",
            },
            {
            ...
            },
            {
                ...
                "cpf": "987.654.321-00",
                "obs": "Cliente demo com prazo proximo.",
            },
            {
            ...
            },
            {
                ...
                "cpf": "456.123.789-55",
                "obs": "Cliente demo com audiencia futura.",
            },
        ]
        ...
        demo_processos = [
            {
                ...
                "descricao": "Acao de indenizacao por danos materiais.",
            ...
            },
            {
                ...
                "descricao": "Reclamacao trabalhista com fase de instrucao.",
                "vara": "18a Vara do Trabalho de Sao Paulo",
            ...
            },
            {
                ...
                "descricao": "Cumprimento de sentenca com prazo de manifestacao.",
                "vara": "1a Vara Civel do Rio de Janeiro",
                "area_juridica": "Civel",
                "status": "Prazo aberto",
            ...
            },
            {
                ...
                "descricao": "Analise contratual e adequacao documental.",
            ...
            },
            {
                ...
                "descricao": "Acao de familia com audiencia ja designada.",
                "vara": "1a Vara de Familia de Curitiba",
        ...
        demo_eventos = [
            {
                ...
                "local": "Forum Central - Sala 4",
                "descricao": "Sessao de conciliacao com proposta inicial.",
            ...
            {
                "titulo": "Reuniao de estrategia trabalhista",
                "cliente": clientes["TecVale Industria Ltda"],
            ...
            },
            {
                ...
                "local": "Portal e-SAJ",
                "descricao": "Protocolar contestacao e anexar comprovantes.",
                "observacoes": "Registro demo para proximos eventos.",
                "day_offset": 1,
                "hour": 17,
                "minute": 0,
                "duration_hours": 1,
            ...
            },
            {
                ...
                "local": "Backoffice",
                "descricao": "Conferir anexos e pendencias cadastrais.",
            ...
            },
            {
                ...
                "prioridade": "Alta",
                "responsavel": usuarios["Gabriel Nunes"].nome,
                "local": "Forum de Familia - Sala 7",
                "descricao": "Oitiva das partes e definicao de novos encaminhamentos.",
                "observacoes": "Audiencia futura para alimentar o calendario.",
                "day_offset": 5,
                "hour": 13,
                "minute": 30,
                "duration_hours": 2,
            ...
            {
                "titulo": "Revisao de contrato comercial",
                "cliente": clientes["TecVale Industria Ltda"],
                "processo": processos["PROC-2026-0002"],
                "tipo_evento": "Reuniao",
                "status": "Concluido",
                ...
                "responsavel": usuarios["Renata Soares"].nome,
                "local": "Videochamada",
                "descricao": "Revisao final de minuta comercial.",
                "observacoes": "Evento concluido para demonstracao.",
                "day_offset": -1,
                "hour": 11,
                "minute": 0,
                "duration_hours": 1,
            ...
            {
                "titulo": "Prazo para manifestacao",
                "cliente": clientes["Mariana Souza"],
                "processo": processos["PROC-2026-0001"],
                "tipo_evento": "Prazo",
                "status": "Atrasado",
                ...
                "descricao": "Manifestacao sobre documentos juntados pela parte contraria.",
                "observacoes": "Evento vencido para demonstracao da agenda.",
                "day_offset": -2,
                "hour": 18,
                "minute": 0,
                "duration_hours": 1,
