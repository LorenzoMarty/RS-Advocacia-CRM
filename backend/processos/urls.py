...
urlpatterns = [
    ...
    path(
        "api/processos/<int:processo_id>/",
        views.detalhes_processo,
        name="detalhes_processo",
    ),
    path(
        "api/processos/<int:processo_id>/editar/",
        views.editar_processo,
        name="editar_processo",
    ),
    path(
        "api/processos/<int:processo_id>/excluir/",
        views.excluir_processo,
